...
/*   Updated: 2025/01/05 18:11:54 by walnaimi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void printem(t_minirt *rt)
{
    ...
    printf("  ID: %d\n", rt->amb.id);
    printf("  Color: (%d, %d, %d)\n", rt->amb.color.R, rt->amb.color.B, rt->amb.color.G);
    printf("  Ratio: %f\n", rt->amb.ratio);
    ...
    printf("  Color: (%d, %d, %d)\n", rt->pl[i].col.R, rt->pl[i].col.B, rt->pl[i].col.G);
    }
    ...
    printf("  Color: (%d, %d, %d)\n", rt->sp[i].col.R, rt->sp[i].col.B, rt->sp[i].col.G);
    printf("  Diameter: %f\n", rt->sp[i].radius);
    }
    ...
    printf("  Color: (%d, %d, %d)\n", rt->cy[i].col.R, rt->cy[i].col.B, rt->cy[i].col.G);
    printf("  Diameter: %f, Height: %f\n", rt->cy[i].radius, rt->cy[i].height);
    }
}
